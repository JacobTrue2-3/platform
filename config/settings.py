...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '77.232.139.86', 'insiders-crys.ru', 'www.insiders-crys.ru']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'users.context_processors.current_theme'
            ],
        },
    },
]
...
if DEBUG:
    ...
    STATIC_ROOT = '/home/python521user/Pikabu-E-python521/static'
...
if DEBUG:
    ...
    MEDIA_ROOT = '/home/python521user/Pikabu-E-python521/media'
